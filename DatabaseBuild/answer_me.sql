...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-05-04 04:47:45
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
INSERT INTO `contain` (`cid`, `hid`) VALUES
(1, 1),
(1, 2),
(1, 3),
(1, 4),
...
INSERT INTO `course` (`cid`, `version`, `picture`, `course_name`, `teacher`, `course_time`, `course_place`, `editor`, `update_time`, `brief`, `profession`, `college`, `school`) VALUES
(1, 1, 'book_1.jpg', '电子商务物流', '王平', '周二3-5节', '公共教学楼B401', 'yangliu', '2014-02-24 12:12:23', '电子商务物流是一整套的电子物流解决方案，就是俗话说的ERP系统，电子上的物流显示及相关操作，物流还是需要机器和人搬运的。电子商务物流还要从传统物流做起。目前国内外的各种物流配送虽然大都跨越了简单送货上门的阶段，但在层次上仍是传统意义上的物流配送，因此在经营中存在着传统物流配送无法克服的种种弊端和问题，尚不具备或基本不具备信息化、现代化、社会化的新型物流配送的特征。', '数字媒体', '软件学院', '中山大学'),
(2, 1, 'book_2.jpg', '实用软件工程', '王军', '周三3-5节', '公共教学楼B302', 'yangliu', '2014-04-21 09:22:31', '软件工程的内容与方法、软件生命周期与开发模型、软件立项与合同、软件需求、软件策划、软件建模、软件设计、软件测试、软件实施与维护和软件管理。', '数字媒体', '软件学院', '中山大学'),
(3, 1, 'book_3.jpg', '高等数学导论', '陆群', '周四13-15节', '公共教学楼C205', 'yanyan', '2014-10-31 23:11:21', '从专业实际需要出发，把教学的重点定位在对学生数学应用能力的培养方面。对教材的编写内容作了创新，首先，在每一节内容的一开始通过一些引例激发学生的兴趣，引出本节内容。其次，在每一节结束都安排知识应用案例，使学生能灵活应用本节知识解决实际问题。最后，在每一节后都有习题，每一章后有复习题给学生提供大量的练习机会。每一章后还安排了数学实验，使学生学会用数学软件解决复杂的数学计算问题。', '计算机应用', '软件学院', '中山大学'),
(4, 1, 'book_4.jpg', '线性代数简明教程', '高成英', '周五9-11节', '公共教学楼A101', 'wangxinyan', '2014-02-24 00:12:20', '行列式，矩阵，向量空间，线性方程组，矩阵的相似对角化，二次型，线性空间与线性变换等。', '电子政务', '软件学院', '中山大学'),
(5, 1, 'book_5.jpg', '离散数学', '吴向军', '周二7-9节', '公共教学楼D103', 'xiaowenhui', '2014-09-15 12:12:57', '离散数学(Discrete mathematics)是研究离散量的结构及其相互关系的数学学科，是现代数学的一个重要分支。离散的含义是指不同的连接在一起的元素，主要是研究基于离散量的结构和相互间的关系，其对象一般是有限个或可数个元素。', '数字媒体', '软件学院', '中山大学'),
(6, 1, 'book_6.jpg', '数字集成电路', '王新明', '周二4-6节', '公共教学楼B202', 'lixiaoliang', '2014-01-22 09:12:23', '数字集成电路是将元器件和连线集成于同一半导体芯片上而制成的数字逻辑电路或系统。根据数字集成电路中包含的门电路或元、器件数量，可将数字集成电路分为小规模集成（SSI）电路、中规模集成MSI电路、大规模集成（LSI）电路、超大规模集成VLSI电路和特大规模集成（ULSI）电路。', '嵌入式软件', '软件学院', '中山大学'),
(7, 1, 'book_7.jpg', '数据库系统教程', '冯剑琳', '周三11-13节', '公共教学楼B101', 'lixiaoliang', '2014-02-25 12:24:25', '数据库基本概念、关系运算、SQL语言、数据库管理、规范化设计、ER模型、高级概念建模活动、对象关系数据库、面向对象数据库、分布式数据库、异构多数据源的访问、XML技术、数据仓库、OLAP技术和数据挖掘。', '嵌入式软件', '软件学院', '中山大学'),
(8, 1, 'book_8.jpg', '计算机网络', '郑贵峰', '周一3-5节', '公共教学楼E504', 'xuhang', '2014-07-21 08:11:23', '系统地介绍了计算机网络的基本概念、原理与技术，包括绪论、物理层、数据链路层、局域网、网络层、传输层、应用层和网络安全共8章内容', '软件工程', '软件学院', '中山大学');
...
INSERT INTO `courseindex` (`cid`, `version`, `like_number`, `taken_number`) VALUES
(1, 1, 12, 21),
(2, 1, 45, 54),
(3, 1, 56, 54),
(4, 1, 89, 66),
...
--
-- 转存表中的数据 `createcourse`
--

INSERT INTO `createcourse` (`uid`, `cid`, `version`, `create_time`) VALUES
(8, 3, 1, '2014-10-31 23:11:21'),
(9, 4, 1, '2014-02-24 00:12:20'),
(12, 8, 1, '2014-07-21 08:11:23'),
(13, 6, 1, '2014-01-22 09:12:23'),
(13, 7, 1, '2014-02-25 12:24:25'),
(14, 5, 1, '2014-09-15 12:12:57'),
(16, 1, 1, '2014-02-24 12:12:23'),
(16, 2, 1, '2014-04-21 09:22:31');
...
CREATE TABLE IF NOT EXISTS `createhw` (
  `uid` int(11) NOT NULL,
  `hid` int(11) NOT NULL,
  `version` int(11) NOT NULL,
  `create_time` datetime NOT NULL,
...
INSERT INTO `createhw` (`uid`, `hid`, `version`, `create_time`) VALUES
(8, 1, 1, '2014-09-09 12:00:21'),
(8, 10, 1, '2014-09-15 19:30:12'),
(8, 19, 1, '2014-09-09 12:00:21'),
(9, 2, 1, '2014-09-16 14:22:22'),
(9, 11, 1, '2014-09-17 12:00:00'),
(9, 20, 1, '2014-09-16 12:00:00'),
(10, 3, 1, '2014-09-23 22:11:20'),
(10, 12, 1, '2014-10-03 12:00:00'),
(10, 21, 1, '2014-09-25 12:00:00'),
(11, 4, 1, '2014-10-07 22:21:33'),
(11, 13, 1, '2014-09-09 12:01:21'),
(11, 22, 1, '2014-10-02 12:00:00'),
(12, 5, 1, '2014-11-09 08:00:21'),
(12, 14, 1, '2014-09-09 15:30:21'),
(13, 6, 1, '2014-11-17 18:12:12'),
(13, 15, 1, '2014-09-21 12:12:21'),
(14, 7, 1, '2014-12-01 19:30:12'),
(14, 16, 1, '2014-09-09 12:00:21'),
(15, 8, 1, '2014-08-21 12:30:12'),
(15, 17, 1, '2014-09-16 12:22:22'),
(16, 9, 1, '2014-09-01 19:30:12'),
(16, 18, 1, '2014-09-23 11:11:20');
...
CREATE TABLE IF NOT EXISTS `editcourse` (
  `uid` int(11) NOT NULL,
  `cid` int(11) NOT NULL,
  `version` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `edithw` (
  `uid` int(11) NOT NULL,
  `hid` int(11) NOT NULL,
  `version` int(11) NOT NULL,
  `edit_time` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `homeworkindex` (
  `hid` int(11) NOT NULL,
  `version` int(11) NOT NULL,
  `like_number` int(11) NOT NULL,
...
--
-- 转存表中的数据 `homeworkindex`
--

INSERT INTO `homeworkindex` (`hid`, `version`, `like_number`, `order`) VALUES
(1, 1, 21, 1),
(2, 1, 45, 2),
(3, 1, 56, 3),
(4, 1, 34, 4),
...
INSERT INTO `take` (`uid`, `cid`, `HW_now`) VALUES
(8, 3, 1),
(8, 8, 1),
(9, 4, 1),
(9, 8, 1),
...
INSERT INTO `user` (`uid`, `username`, `password`, `email`, `experience`, `school`, `college`, `profession`, `entry_year`) VALUES
(8, 'yanyan', '7219b9b60d9d70a9a7014369d88ebefe', '1966997923@qq.com', 0, '软件学院', '中山大学', '计算机应用', 2012),
(9, 'wangxinyan', '5340ed252aa12739b42559526f69ff60', '364313689@qq.com', 0, '软件学院', '中山大学', '电子政务', 2012),
(10, 'shuizemin', '9738ac83e94f6f2ceee775671ed144d0', '1264717771@qq.com', 0, '软件学院', '中山大学', '电子政务', 2012),
(11, 'wanchengcheng', 'b7ddf2777eea41f8e1bc82bc685c18a8', '714146815@qq.com', 0, '软件学院', '中山大学', '电子政务', 2012),
(12, 'xuhang', '3f29480477e45b147c3c195a6edbcbec', '466356670@qq.com', 0, '软件学院', '中山大学', '数字媒体', 2013),
(13, 'lixiaoliang', '3b13764d806412660601bee526e389c9', '348004611@qq.com', 0, '软件学院', '中山大学', '嵌入式软件', 2012),
(14, 'xiaowenhui', 'fa8d0e69e819e64fbb92dc970d82e575', '522171087@qq.com', 0, '软件学院', '中山大学', '数字媒体', 2012),
(15, 'liuyongkang', 'baaa7238969070e7ac5c77e6e8a341c6', '876687680@qq.com', 0, '软件学院', '中山大学', '通用软件', 2012),
(16, 'yangliu', '89da5f1bc89f0a8870e980286c94d87f', '1151730511@qq.com', 0, '软件学院', '中山大学', '数字媒体', 2012);
...
--
ALTER TABLE `contain`
  ADD CONSTRAINT `contain_ibfk_1` FOREIGN KEY (`cid`) REFERENCES `courseindex` (`cid`),
  ADD CONSTRAINT `contain_ibfk_2` FOREIGN KEY (`hid`) REFERENCES `homeworkindex` (`hid`);

--
-- 限制表 `createcourse`
--
ALTER TABLE `createcourse`
  ADD CONSTRAINT `createcourse_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`),
  ADD CONSTRAINT `createcourse_ibfk_2` FOREIGN KEY (`cid`, `version`) REFERENCES `course` (`cid`, `version`);

--
-- 限制表 `createhw`
--
ALTER TABLE `createhw`
  ADD CONSTRAINT `createhw_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`),
  ADD CONSTRAINT `createhw_ibfk_2` FOREIGN KEY (`hid`, `version`) REFERENCES `homework` (`hid`, `version`);

--
-- 限制表 `editcourse`
--
ALTER TABLE `editcourse`
  ADD CONSTRAINT `editcourse_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`),
  ADD CONSTRAINT `editcourse_ibfk_2` FOREIGN KEY (`cid`, `version`) REFERENCES `course` (`cid`, `version`);

--
-- 限制表 `edithw`
--
ALTER TABLE `edithw`
  ADD CONSTRAINT `edithw_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`),
  ADD CONSTRAINT `edithw_ibfk_2` FOREIGN KEY (`hid`, `version`) REFERENCES `homework` (`hid`, `version`);

--
-- 限制表 `own`
--
ALTER TABLE `own`
  ADD CONSTRAINT `own_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`),
  ADD CONSTRAINT `own_ibfk_2` FOREIGN KEY (`mid`) REFERENCES `material` (`mid`);

--
-- 限制表 `take`
--
ALTER TABLE `take`
  ADD CONSTRAINT `take_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`),
  ADD CONSTRAINT `take_ibfk_2` FOREIGN KEY (`cid`) REFERENCES `courseindex` (`cid`);
...
ALTER TABLE `upload`
  ...
  ADD CONSTRAINT `upload_ibfk_2` FOREIGN KEY (`mid`) REFERENCES `material` (`mid`);
