   ...
   <!-- 除了添加，不要改动一切其他东西--> 
    <div class= "span1">
      ...
      <div class="not_found hidden">
        ...
        <a class="btn btn-default buttons" href="http://localhost/answer_me/home.php/HomePage" role="button">回到首页</a>
        <a class="btn btn-default buttons" href="http://localhost/answer_me/home.php/AddCoursePage" role="button">创建课程</a>
      </div>
