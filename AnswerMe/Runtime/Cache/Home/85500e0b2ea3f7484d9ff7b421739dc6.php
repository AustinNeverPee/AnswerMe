...
<html lang="en">
	<head>
		...
		<!--添加你的CSS-->
        <link href="/answer_me/AnswerMe/Common/Static/css/userhistory.css" rel="stylesheet">
		<!--收藏夹图标-->
	...
	<body>	
            ...
            <div class="left">
				...
				<div class="col-xs-4">
					<div class="time-list todo">
						...
						<ul>
                            <li class="time-list-item" id = "course_edit">
                                <div class="todo-content">
                                    <h4 class="time-name todo-name" >课程编辑历史</h4>
                                </div>
                            </li>
							<li class="time-list-item">
								<div class="todo-content" id = "hw_edit">
									<h4 class="time-name todo-name" >作业编辑历史</h4>
								</div>
							</li>
						</ul>
					</div>
		...
		<script src="/answer_me/AnswerMe/Common/Static/js/userhistory.js"></script>
		<!--添加你的js文件-->
	</body>
</html>