...
<html lang="en">
  <head>
    ...
    <link href="/answer_me/AnswerMe/Common/Static/css/addcourse.css" rel="stylesheet">

    <!--收藏夹图标-->
    <link rel="shortcut icon" href="resource/favor-icon.jpg">
  </head>
      ...
      <div class="right-content">
        <div class="sum">
          ...
          <div class="infos">
            <span>
              <label >学校</label>
              <select class="form-control" id="course_college">
                <option>选择你的学校</option>
                <option>中山大学</option>
                <option>清华大学</option>
                <option>北京大学</option>
            ...
            <span>
              <label >学院</label>
              <select class="form-control" id="course_school">
                <option>选择你的学院</option>
                <option>软件学院</option>
                <option>岭南学院</option>
                <option>医学院</option>
            ...
            <span>
              <label >专业</label>
              <select class="form-control" id="course_major">
                <option>选择你的专业</option>
                <option>数字媒体</option>
                <option>电子政务</option>
                <option>嵌入式软件</option>
            ...
            <span>
              <label>年级</label>
              <select class="form-control" id="course_grade">
                <option>选择你的入学年份</option>
                <option>2014</option>
                <option>2013</option>
                <option>2012</option>
          ...
          <div class="infos">
            <label >课程名称</label>
            <input class="form-control" id="course_name">
          
            <label >任课教师</label>
            <input  class="form-control" id="course_teacher">
         
            <label >上课时间</label>
            <input  class="form-control" id="course_time">
          
            <label >上课地点</label>
            <input  class="form-control" id="course_place">
          </div>
        </div>
      </div>
      <div id="finish">
        <center><button class="btn btn-primary">完成编辑</button></center>
      </div>
    </div>
