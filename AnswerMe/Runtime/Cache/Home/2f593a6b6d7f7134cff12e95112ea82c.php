				...
				<div class="col-xs-4">
					<div class="course-list todo">
						...
						<ul class="course-lists">
							<?php if(is_array($homeworks)): $i = 0; $__LIST__ = $homeworks;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$homework): $mod = ($i % 2 );++$i;?><li class="course-list-item" id="<?php echo ($homework["cid"]); ?>">
									<div class="course-content todo-content">
										<h4 class="course-name todo-name"><?php echo ($homework["course_name"]); ?></h4>
									</div>
						...
						<div class="info-bar">
							<div class="course-info-bar">
								...
								<div class="info">
									...
									<br>
									<span class="else">任课教师：</span>
									<span class="else" id="course-teacher"></span>
									<br>
									<span class="else">上课地点：</span>
									<span class="else" id="course-place"></span>
									<br>
									<span class="else">上课时间：</span>
									<span class="else" id="course-time"></span>
									<br>
								...
								<div class="takelike">
									...
									<span class="else else-num" id="good"></span>
								</div>
							</div>
							...
							<div class="h-list-info">
								<div class="hw-list-info">
	    							<div class="tile hw-list add-homework">
										<span class="else"><a class="book">添加新的作业</a></span>
	    							</div>
								</div>
							</div>
						</div>
